...
class MedicineimageSpiderMiddleware(object):
...
class MedicineimageDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class MedicineImage123DownloaderMiddleware(object):
    ...
    def process_exception(self, request, exception, spider):
        print("添加代理开始")
        ret_proxy = random.choice(user_agent_list)
        # 在请求头里设置ret_proxy
        request.headers.setdefault("User-Agent", ret_proxy)
